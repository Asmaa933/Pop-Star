        ...
        let parameters = ["api_key": apiKey , "language" : "en-US"]
            Alamofire.request(url, method: .get, parameters: parameters, encoding: URLEncoding.default, headers: nil).validate().responseJSON{(response) in
               ...
               case .success:
                ...
                let movieDetails = MovieModel(original_title: original_title, poster_path: poster_path, overview: overview, release_date: release_date, vote_average: vote_average, id: movieID)
